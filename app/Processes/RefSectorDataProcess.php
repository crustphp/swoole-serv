...
use App\Services\RefSectorDataService;

class RefSectorDataProcess {
    ...
    public function handle()
    {
        ...
        $refDataService = new RefSectorDataService(server: $this->server, process: $this->process, objDbPool: $this->objDbPool, refTokenLock: $this->lock);
