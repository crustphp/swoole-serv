...
return [
    ...
    'ref_historical_fields' => $_ENV['SW_REF_HISTORICAL_FIELDS'],
    'ref_historical_data_fetching_timespan' =>  intval($_ENV['SW_REF_HISTORICAL_DATA_FETCHING_TIMESPAN'] ?? 60),
    'ref_historical_data_fetching_starttime' =>  $_ENV['SW_REF_HISTORICAL_DATA_FETCHING_STARTTIME'] ?? '10:15',
    'ref_historical_data_fetching_endtime' =>  $_ENV['SW_REF_HISTORICAL_DATA_FETCHING_ENDTIME'] ?? '15:30',
    'ref_historical_data_flash_starttime' =>  $_ENV['SW_REF_HISTORICAL_DATA_FLASH_STARTTIME'] ?? '09:30',
    'ref_historical_data_flash_endtime' =>  $_ENV['SW_REF_HISTORICAL_DATA_FLASH_ENDTIME'] ?? '10:14',
    'ref_historical_previous_day_data_starttime' =>  $_ENV['SW_REF_HISTORICAL_PREVIOUS_DAY_DATA_STARTTIME'] ?? '0:00',
    'ref_historical_previous_day_data_endtime' =>  $_ENV['SW_REF_HISTORICAL_PREVIOUS_DAY_DATA_ENDTIME'] ?? '9:29',
    'ref_historical_market_common_attributes' => $_ENV['SW_REF_HISTORICAL_MARKET_COMMON_ATTRIBUTES'],
