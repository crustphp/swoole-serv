...
$swoole_config = [
    ...
    'server_settings' => [
        ...
        'reactor_num' => 16,
        'worker_num' => intval($_ENV['SW_WORKERS_NUM'] ?? 4), // Each worker holds a connection pool
        'task_worker_num' => intval($_ENV['SW_TASK_WORKERS_NUM'] ?? 0),  // The amount of task workers to start
